...
if not os.path.isfile(final_RFC_FE_model_file): # If the model is not present
    url = r'https://github.com/abhijitdinesh/sql_injection_detection/tree/main/model/final_RFC_FE_model.model?raw=true' # URL of the model
...
if not os.path.isfile(tfidf_vec_file):					# If the vectorizer is not present
    url = r'https://github.com/abhijitdinesh/sql_injection_detection/tree/main/model/tfidf_vec.sav?raw=true'	# URL of the vectorizer
